// -----------------------------------------------------------------------
// <copyright file="TrackLoadedEventArgs.cs" company="Klybok Team">
...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="TrackLoadedEventArgs"/> class.
    /// </summary>
    ...
    /// <param name="queuePos">Next queue played track.</param>
    public TrackLoadedEventArgs(MusicInstance musicInstance, string track, bool directPlay, int queuePos)
    {
    ...
    /// <param name="directPlay">Track are forced to play or not. (queue == -1).</param>
    /// <param name="queuePos">Next queue played track.</param>
    public TrackLoadedEventArgs(MusicInstance musicInstance, AudioFile track, bool directPlay, int queuePos)
    {
        this.MusicInstance = musicInstance;
